package cn.chason678.mqttClientPt.security;
...
import cn.chason678.mqttClientPt.proto.messages.SubscribeMessage;
...
//        });
    ...
    public void authorizeSubscribe(String token, List<SubscribeMessage.Couple> topics, Handler<JsonArray> authHandler) {
